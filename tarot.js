  ...
  turn() {
    ...
    do {
      ...
      if (typeof this.playerOne.playerDeck[0].Suit != "undefined") {
        console.log(
          `Player One flipped a ${this.playerOne.playerDeck[0].Place} of ${this.playerOne.playerDeck[0].Suit}`
        );
      } else {
        console.log(
          `Player One flipped the ${this.playerOne.playerDeck[0].Trump}(${this.playerOne.playerDeck[0].Place})`
        );
      }
      ...
      if (typeof this.playerTwo.playerDeck[0].Suit != "undefined") {
        console.log(
          `Player Two flipped a ${this.playerTwo.playerDeck[0].Place} of ${this.playerTwo.playerDeck[0].Suit}`
        );
      } else {
        console.log(
          `Player Two flipped the ${this.playerTwo.playerDeck[0].Trump}(${this.playerTwo.playerDeck[0].Place})`
        );
      }
